...
<script>
    $(document).ready(function() {
        ...
        /*وقف ابدال*/ //u0629 --> ة    //u0627

        n = n.replace(/(﴿)/g, "<span class='ayesign'>﴿</span>");
        n = n.replace(/([0-9])/g, "<span class='ayeNum'>$1</span>");
        n = n.replace(/(﴾ )/g, "<span class='ayesign'>﴾ </span>");

        // /*ادغام*/   n = n.replace(/(\u0646\u0652\s[\u064A\u0631\u0645\u0644\u0648\u0646])|(\u064D\s[\u064A\u0631\u0645\u0644\u0648\u0646])|(\u064C\s[\u064A\u0631\u0645\u0644\u0648\u0646])|(\u064B\s[\u064A\u0631\u0645\u0644\u0648\u0646])|(\u064B\u0627\s[\u064A\u0631\u0645\u0644\u0648\u0646])/g, "<span class='redcolor'>$1$2$3$4$5</span>"); // !!!! تجوید: نون ساکن و تنوین - ادغام - در کروم درسته ولی در فایرفاکس جدا نشون میده
